                ...
                {guide ? (
                  ...
                  <div className="flex items-center justify-center min-h-[400px]">
                    <div className="text-center">
                      ...
                      <a
                        href="/assessment"
                        className="mt-4 px-6 py-3 bg-blue-600 text-white rounded-xl font-bold hover:bg-blue-700 transition-colors inline-block"
                      >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              ...
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-xs md:text-sm">
                  ...
                  <li>
                    <a href="/assessment" className="text-slate-600 hover:text-blue-600 transition-colors font-medium">
                      လမ်းညွှန်ချက်ရယူရန်
                    </a>
                  </li>
                  <li>
